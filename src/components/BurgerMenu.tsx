import { Menu, Settings, Users, FileText, HelpCircle, LogOut, LayoutDashboard, MapPin, Plus, List, ChevronRight, Route, Image } from "lucide-react";
...
export const BurgerMenu = ({ onNavigateToDashboard, onNavigateToPoi }: BurgerMenuProps) => {
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded shadow-lg border border-gray-200 py-2 z-50">
          ...
          >
            ...
            {/* Flyout Submenu */}
            {hoveredSubmenu === 'poi' && (
              <div className="absolute left-full top-0 ml-1 w-48 bg-white rounded shadow-lg border border-gray-200 py-2 z-50">
                <button
                  onClick={() => {
                    onNavigateToPoi?.();
                    setIsOpen(false);
