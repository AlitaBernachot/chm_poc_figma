...
export function HistorySection() {
  ...
  const [isHistoryExpanded, setIsHistoryExpanded] =
    useState(true);
  const [expandedVersions, setExpandedVersions] = useState<Set<string>>(new Set(["v7", "v5"]));
          ...
          <>
            ...
            {historyTab === "edits" && (
              <div className="space-y-3">
                ...
                <div className="border border-gray-200 rounded bg-white hover:bg-gray-50 transition-colors overflow-hidden">
                  <div className="p-4">
                    <div className="flex items-center justify-between gap-4 mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          title="View changes"
                        >
                          <ChevronDown className={`w-3.5 h-3.5 transition-transform ${expandedVersions.has("v7") ? "rotate-180" : ""}`} />
                          {expandedVersions.has("v7") ? "Hide update details" : "Show update details"}
                        </button>
                        <button
                          className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-100 transition-colors whitespace-nowrap"
                  ...
                  {/* Expanded Changes */}
                  {expandedVersions.has("v7") && (
                    <div className="border-t border-gray-200 bg-gray-50 p-4 space-y-4">
                      {/* German Title Change */}
                      <div className="bg-white rounded border border-gray-200 p-3">
                        <div className="flex items-center gap-2 mb-2">
                          <User className="w-4 h-4 text-indigo-600" />
                          <span className="text-sm font-semibold text-gray-800">German Title Updated</span>
                        </div>
                        <div className="space-y-2">
                          <div className="flex items-start gap-2">
                            <div className="w-6 h-6 flex items-center justify-center rounded bg-red-100 text-red-700 text-xs font-bold flex-shrink-0 mt-0.5">
                              −
                            </div>
                            <div className="flex-1 bg-red-50 border border-red-200 rounded px-3 py-2">
                              <p className="text-sm text-red-800 line-through">Historischer Wanderpfad am Rhein</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-2">
                            <div className="w-6 h-6 flex items-center justify-center rounded bg-green-100 text-green-700 text-xs font-bold flex-shrink-0 mt-0.5">
                              +
                            </div>
                            <div className="flex-1 bg-green-50 border border-green-200 rounded px-3 py-2">
                              <p className="text-sm text-green-800 font-medium">Historischer Rheinwanderweg mit Panoramablick</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded border border-gray-200 p-3">
                        <div className="flex items-center gap-2 mb-2">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-sm font-semibold text-gray-800">Tags Added</span>
                            <div className="flex items-center gap-1 px-2 py-0.5 rounded text-xs font-medium" style={{ background: 'linear-gradient(135deg, #8b5cf6 0%, #3b82f6 100%)', color: 'white' }}>
                        ...
                        <div className="flex flex-wrap gap-2 mt-2">
                          <span className="px-2.5 py-1 bg-green-100 text-green-700 rounded text-xs font-medium border border-green-200">
                            + scenic-view
                          </span>
                          <span className="px-2.5 py-1 bg-green-100 text-green-700 rounded text-xs font-medium border border-green-200">
                            + family-friendly
                      ...
                      <div className="bg-white rounded border border-gray-200 p-3">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm font-semibold text-gray-800">Route Association Added</span>
                        </div>
                        <div className="bg-blue-50 border border-blue-200 rounded px-3 py-2">
                          <div className="flex items-center gap-2">
                            <div className="w-6 h-6 flex items-center justify-center rounded bg-blue-100 text-blue-700 text-xs font-bold flex-shrink-0">
                              +
                            </div>
                            <div className="flex-1">
                              <p className="text-sm text-blue-800 font-medium">Rhine Valley Trail #47</p>
                              <p className="text-xs text-blue-600 mt-0.5">Connected at km 12.3</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded border border-gray-200 p-3">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm font-semibold text-gray-800">Coordinates Updated</span>
                        </div>
                        <div className="space-y-2">
                          <div className="flex items-start gap-2">
                            <div className="w-6 h-6 flex items-center justify-center rounded bg-red-100 text-red-700 text-xs font-bold flex-shrink-0 mt-0.5">
                            ...
                            <div className="flex-1 bg-red-50 border border-red-200 rounded px-3 py-2">
                              <p className="text-xs text-red-600 font-mono">Previous</p>
                              <p className="text-sm text-red-800 font-mono mt-1">47.5574° N, 7.5891° E</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-2">
                            <div className="w-6 h-6 flex items-center justify-center rounded bg-green-100 text-green-700 text-xs font-bold flex-shrink-0 mt-0.5">
                            ...
                            <div className="flex-1 bg-green-50 border border-green-200 rounded px-3 py-2">
                              <p className="text-xs text-green-600 font-mono">Current</p>
                              <p className="text-sm text-green-800 font-mono mt-1">47.5582° N, 7.5903° E</p>
                              <p className="text-xs text-green-600 mt-1">
                                ↗ Shifted 110m northeast (more accurate position)
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <div className="border border-gray-200 rounded bg-white hover:bg-gray-50 transition-colors overflow-hidden">
                  <div className="p-4">
                    <div className="flex items-center justify-between gap-4 mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() => toggleVersion("v5")}
                          className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-100 transition-colors whitespace-nowrap"
                          title="View changes"
                        >
                          <ChevronDown className={`w-3.5 h-3.5 transition-transform ${expandedVersions.has("v5") ? "rotate-180" : ""}`} />
                          {expandedVersions.has("v5") ? "Hide" : "Show"}
                        </button>
                        <button
                          className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-100 transition-colors whitespace-nowrap"
                          title="Restore to this version"
                  ...
                  {expandedVersions.has("v5") && (
                    <div className="border-t border-gray-200 bg-gray-50 p-4 space-y-4">
                      ...
                      <div className="bg-white rounded border border-gray-200 p-3">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-start gap-2">
                            ...
                            <div className="flex-1 bg-red-50 border border-red-200 rounded px-3 py-2">
                              <p className="text-sm text-red-800 line-through">Wanderweg zum Aussichtspunkt</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-2">
                            <div className="w-6 h-6 flex items-center justify-center rounded bg-green-100 text-green-700 text-xs font-bold flex-shrink-0 mt-0.5">
                            ...
                            <div className="flex-1 bg-green-50 border border-green-200 rounded px-3 py-2">
                              <p className="text-sm text-green-800 font-medium">Historischer Wanderpfad am Rhein</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded border border-gray-200 p-3">
                        <div className="flex items-center gap-2 mb-2">
                          <div className="flex items-center gap-1.5">
                            ...
                            <span className="text-sm font-semibold text-gray-800">Tags Added</span>
                            <div className="flex items-center gap-1 px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-700 border border-gray-300">
                      ...
                      <div className="bg-white rounded border border-gray-200 p-3">
                        ...
                        <div className="bg-blue-50 border border-blue-200 rounded px-3 py-2">
                          <div className="flex items-center gap-2">
                            ...
                            <div className="flex-1">
                              <p className="text-sm text-blue-800 font-medium">SwissMobil Route #33</p>
                              <p className="text-xs text-blue-600 mt-0.5">Point of interest at km 8.7</p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded border border-gray-200 p-3">
                        <div className="flex items-center gap-2 mb-2">
                          <MapPin className="w-4 h-4 text-orange-600" />
                          <span className="text-sm font-semibold text-gray-800">Coordinates Corrected</span>
                        </div>
                        <div className="space-y-2">
                          <div className="flex items-start gap-2">
                            <div className="w-6 h-6 flex items-center justify-center rounded bg-red-100 text-red-700 text-xs font-bold flex-shrink-0 mt-0.5">
                            ...
                            <div className="flex-1 bg-red-50 border border-red-200 rounded px-3 py-2">
                              <p className="text-xs text-red-600 font-mono">Previous</p>
                              <p className="text-sm text-red-800 font-mono mt-1">47.5615° N, 7.5967° E</p>
                            </div>
                          </div>
                          <div className="flex items-start gap-2">
                            <div className="w-6 h-6 flex items-center justify-center rounded bg-green-100 text-green-700 text-xs font-bold flex-shrink-0 mt-0.5">
                            ...
                            <div className="flex-1 bg-green-50 border border-green-200 rounded px-3 py-2">
                              <p className="text-xs text-green-600 font-mono">Current</p>
                              <p className="text-sm text-green-800 font-mono mt-1">47.5574° N, 7.5891° E</p>
                              <p className="text-xs text-green-600 mt-1">
                                ↙ Shifted 515m southwest (GPS verification)
                              </p>
                            </div>
                          </div>
                        </div>
